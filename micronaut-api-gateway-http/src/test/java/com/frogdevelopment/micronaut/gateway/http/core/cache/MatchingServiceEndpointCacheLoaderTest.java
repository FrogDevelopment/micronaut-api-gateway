...
class MatchingServiceEndpointCacheLoaderTest {

    private static final String INPUT = "any";

    @InjectMocks
    private MatchingServiceEndpointCacheLoader matchingServiceEndpointCacheLoader;
    ...
    void should_return_emptyOptional_when_emptyMatchers() {
        ...
        // when
        var optional = matchingServiceEndpointCacheLoader.load(INPUT);
